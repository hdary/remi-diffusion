...
title: Acquisition
actions:
  - label: 1. L'IRM de diffusion
    url: /docs/acquisition/01-diffusion.md
  - label: 2. Contraintes liées à l'organe
    url: /acquisition/02-organes.md
  ...
  - label: 7. Multicentrique
    url: /acquisition/07-multicentrique.md
  - label: 8. À la console
    url: /acquisition/08-console.md
  - label: 9. Export
    url: /acquisition/09-export.md
---
